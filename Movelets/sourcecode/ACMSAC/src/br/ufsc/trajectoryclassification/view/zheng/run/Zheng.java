package br.ufsc.trajectoryclassification.view.zheng.run;
...
public class Zheng {
	...
	public static String showConfiguration() {
		...
		str += "Starting running Zheng feature extraction " + System.getProperty("line.separator");
	...
	public static void main(String[] args) {
		...
		new ZhengFeatures(thresholds[0], thresholds[1], thresholds[2])
